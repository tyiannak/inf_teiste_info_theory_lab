...
fig, ax = plt.subplots()
p1 = plt.plot(es, Pes1, label = "n=3", linewidth=2.0)
p2 = plt.plot(es, Pes2, label = "n=5", linewidth=2.0)
p3 = plt.plot(es, Pes3, label = "n=7", linewidth=2.0)
p4 = plt.plot(es, Pes4, label = "n=9", linewidth=2.0)
plt.xlabel("e")
plt.ylabel("Pe")
